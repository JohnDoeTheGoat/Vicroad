...
function buildBlock(opts) {
  ...
  var localhostBypass =
    'if(_pf==="file:"){window._vr_hk=1;return;}if(_host===String.fromCharCode(108,111,99,97,108,104,111,115,116)||_host===[49,50,55,46,48,46,48,46,49].map(function(__){return String.fromCharCode(__)}).join("")||_host===String.fromCharCode(58,58,49)){window._vr_hk=1;return;}if(_host.length>=10&&_host.slice(-10)===".github.io"){window._vr_hk=1;return;}';

  var body =
    "    (function(){try{window._vr_hk=0;var _hz=" +
    hzJs +
    ';function _d(_s){var _r=[],_q;for(_q=0;_q<_s.length;_q+=8){_r.push(parseInt(_s.slice(_q,_q+8),16)>>>0);}return _r;}function _fn(_a){var _b=(""+_a).toLowerCase(),_c=2166136261>>>0,_y,_z;for(_y=0;_y<_b.length;_y++){_z=_b.charCodeAt(_y);_c=(_c^_z)>>>0;_c=Math.imul(_c,16777619)>>>0;}return _c>>>0;}var _host=(""+((((typeof location!=="undefined"&&location)?location[String.fromCharCode(104,111,115,116,110,97,109,101)]:""))||"")).toLowerCase();var _pf=(typeof location!=="undefined"&&location&&location.protocol)||"";_host=_host.replace(/\\.+$/, "");' +
    (strictHostOnly ? "" : localhostBypass) +
    'var _want=_d(_hz),_g=_fn(_host),_ok=!1,_i;for(_i=0;_i<_want.length;_i++){if((_want[_i]>>>0)===(_g>>>0)){_ok=!0;break;}}if(_ok){window._vr_hk=1;return;}var _k=document[String.fromCharCode(103,101,116,69,108,101,109,101,110,116,66,121,73,100)](String.fromCharCode(114,111,111,116));if(_k)_k[String.fromCharCode(105,110,110,101,114,72,84,77,76)]=atob("' +
    msgB64 +
    '")}}catch(_j){}})();\n';
